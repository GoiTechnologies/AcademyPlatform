      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item text-right" style="padding-left:20px; ">
              ...
              style="margin-left:15px; height:39px; color:#fff;" id="shopingcart_btn"
...
<div id="banners" style="margin-top:-50px;">
<div id="carouselExampleIndicators"
 ...
 class="carousel slide" data-ride="carousel">
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
	...
	<div class="row">
		<div class="col-md-12">
			<h2 class="text-danger">Top Cursos <b class="text-primary">Más Vístos</b></h2>
  ...
  <div class="container-fluid text-center text-md-left">
    ...
    <div class="row">
      ...
      <div class="col-md-6 mt-md-0 mt-3">
        ...
        <p>Loscursos en venta asi como su liberacion estan sujetos a disponivilidad de stock y
        posibilidad de transamición, para dudas y ó aclaraciones  puedes consultarnos al correo: soporte@goicoin.net ó
...
$( "#category_selection" ).change(function() {
  ...
  function cart_add(id){
    ...
    if(user == ''){
      alertify.success('Accede o Registrate Gratis <i class="fas fa-user-plus"></i> para usar Carrito !');
      //alert('Accede o Registrate Gratis para usar Carrito!!');
      //window.location.href = "{{URL::to('/') }}/login";
    }else{
      // logica de agregar a carrito
      //alert('Agredado a tu Carrito!!');
      alertify.success('Agregado a tu Carrito <i class="fas fa-cart-plus"></i>');
      var form = document.createElement("form");
      var element1 = document.createElement("input");
      var element2 = document.createElement("input");
