...
.star-rating i {
    ...
    <a href="{{ URL::to('/') }}/mis_cursos">
          <img src="{{ URL::to('/') }}/ss2.jpg"/>
          <h3><i class="fas fa-arrow-alt-circle-left"></i> Ir a mis Cursos</h3></a>
</div>
...
<!-- Footer -->
<footer class="row page-footer font-small teal pt-4 row"
style="margin-top:50px;  color:#fff; background-color:#000; width:101%; padding-left:30px;">
