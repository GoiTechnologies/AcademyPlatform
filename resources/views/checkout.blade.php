...
<div class="container" id="div_main" style="margin-top:60px;">

  <a  href="{{ URL::to('/') }}/mis_cursos">
  <img class="photo" src="{{ URL::to('/') }}/all.jpg"  width="100%"/>
</a>
    ...
    <div class="table-wrapper">
        <div class="table-title" style="background-color:#000;">
            <div class="row">
                <div class="col-sm-6">
        <h3>2.- Cursos en mi <b>Carrito <i class="fas fa-shopping-cart"></i></b></h3>
      </div>
